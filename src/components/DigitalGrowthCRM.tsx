...
export default function DigitalGrowthCRM() {
  ...
  return <div className="min-h-screen bg-[#F5F7FA] p-4 md:p-8"><div className="max-w-7xl mx-auto"><a href="/admin/workspace" className="text-sm font-semibold text-[#1A365D]">← Sales Control Center</a><div className="mt-3 mb-6"><h1 className="text-3xl font-bold text-[#1A365D]">📈 Digital Growth</h1><p className="text-gray-500 mt-1">Private internal marketing and lead-generation control center.</p></div><div className="grid md:grid-cols-3 gap-4"><a href="/admin/campaign-performance?source=meta" className="block bg-white rounded-2xl border p-6 hover:shadow-md hover:border-[#1A365D] transition cursor-pointer"><b>📘 Meta Ads</b><p className="text-sm text-gray-500 mt-2">Open Meta campaign performance, enquiries and source results.</p><span className="inline-block mt-4 text-sm font-semibold text-[#1A365D]">Open Meta Ads →</span></a><a href="/admin/campaign-performance?source=google" className="block bg-white rounded-2xl border p-6 hover:shadow-md hover:border-[#1A365D] transition cursor-pointer"><b>🔎 Google Ads</b><p className="text-sm text-gray-500 mt-2">Open Google campaign performance, enquiries and source results.</p><span className="inline-block mt-4 text-sm font-semibold text-[#1A365D]">Open Google Ads →</span></a><a href="/admin/leads-growth" className="block bg-white rounded-2xl border p-6 hover:shadow-md hover:border-[#1A365D] transition cursor-pointer"><b>🎯 Lead Generation</b><p className="text-sm text-gray-500 mt-2">Open lead acquisition, campaign and growth actions.</p><span className="inline-block mt-4 text-sm font-semibold text-[#1A365D]">Open Lead Generation →</span></a></div><div className="mt-6 bg-white rounded-2xl border p-6"><h2 className="text-xl font-bold text-[#1A365D]">Internal use only</h2><p className="text-sm text-gray-600 mt-2">Digital marketing metrics are kept inside the CRM. Customers see property inventory, enquiries, site visits and contact options—not internal campaign strategy or performance data.</p></div></div></div>;
}
